...
// UnSung VC
	if (_faction==5) then {
	_InfPool=	["uns_local_vc1a","uns_local_vc1f","uns_local_vc2e","uns_local_vc2a", "uns_local_vc1b", "uns_local_vc2b", "uns_local_vc1c", "uns_local_vc1d", "uns_local_vc2c", "uns_local_vc1e", "uns_local_vc2d"];	
	_ArmPool=	[];
	_MotPool=	[];
	_ACHPool=	[];
	_CHPool=	[];
